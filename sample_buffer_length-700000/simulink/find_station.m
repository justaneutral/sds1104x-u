...
%find_station_direction(-36000,6000,1,0.002) % North Dakota, USA
%find_station_direction(-60000,20,0.1,0.002) % WWVB, Colorado
...
%find_station_direction(-29760,20,1,0.02) % points to 0 at needle 45

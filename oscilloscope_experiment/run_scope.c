...
#define INPUT_N (7000000) //(140000) //(7000000) //(65536) //8192 //16384 //4096 //1024
...
int run_scope_n(int n)
{
	...
	m = 0;
        ...
        {
	    if(0 != oscilloscope_data_file_write(buf_before[0], buf_before[1], buf_before[2], buf_before[3], 100000000.0 /*nanoseconds*/)) goto _prtn1;
            for (int ch = 0; ch < DEFAULT_K; ch++)
            {
